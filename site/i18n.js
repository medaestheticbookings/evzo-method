...
(function () {
  ...
  var EL = {
    ...
    "Reject": "Απόρριψη",
    "OK": "Εντάξει",
    "What you allow": "Τι επιτρέπεις",
    "Remembering this choice. Cannot be switched off.": "Η απομνημόνευση αυτής της επιλογής. Δεν απενεργοποιείται.",
    "Anonymous page counts. Never your answers or your email.": "Ανώνυμη καταμέτρηση σελίδων. Ποτέ οι απαντήσεις ή το email σου.",
    "Which advert led to a sale. Nothing health-related.": "Ποια διαφήμιση οδήγησε σε πώληση. Τίποτα σχετικό με την υγεία.",
    "Save": "Αποθήκευση",
